...
export default function AbdullahVisionClient() {
  ...
  const handleDownload = () => {
    if (resultImage) {
      ...
      link.download = `abdullah-vision-${Date.now()}.png`;
    ...
    return (
        <div className="flex flex-col h-screen bg-muted/40 text-foreground" dir={dir}>
            <header className="grid grid-cols-3 items-center p-4 border-b shrink-0 bg-background">
                ...
                <h1 className="text-xl font-semibold tracking-tight justify-self-center">{t('abdullahVisionTitle')}</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                  ...
                  <Card className="shadow-lg animate-in fade-in-50 duration-500">
                      <CardHeader>
                          ...
                          {t('abdullahVisionTitle')}
                          </CardTitle>
                          <CardDescription>{t('abdullahVisionDesc')}</CardDescription>
                      </CardHeader>
                      <CardContent>
