...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    daUploadPromptDesc: "Upload a CSV, XLSX, PDF, or journal (.jrn) file to generate a dashboard with insights and visualizations.",
    ...
    daDragDropUnsupported: "Please upload a CSV, XLSX, PDF, or .jrn file.",
    daDragDropValid: "Drop file to start analysis",
    daDragDropInvalid: "Unsupported file type",
    daDragDropSupported: "Supported: CSV, XLSX, PDF, JRN",
    ...
    spreadsheetImportSuccess: 'Spreadsheet imported successfully.',
    spreadsheetImportFailedTitle: 'Import Failed',
    spreadsheetImportFailedDesc: 'Could not parse this file. Try CSV, XLSX, JSON, TSV, TXT, or JRN.',
    spreadsheetEmptyHint: 'Import a spreadsheet to begin editing and AI-assisted analysis.',
    spreadsheetLoadedMessage: 'Sheet loaded ({{rows}} rows, {{cols}} columns) and ready for AI assistance.',
    ...
    spreadsheetYou: 'You',
    spreadsheetAi: 'AI',
    spreadsheetPromptPlaceholder: 'Ask AI to clean rows, explain anomalies, generate KPIs, or draft a report...',
    spreadsheetAskAi: 'Ask AI',
    spreadsheetAnalyze: 'Analyze',
    spreadsheetReport: 'Generate Report',
    spreadsheetCharts: 'Suggest Charts',
    spreadsheetOpenChartBuilder: 'Chart Builder',
    spreadsheetChartBuilderDesc: 'Pick chart type and fields using AI suggestions or customize manually.',
    spreadsheetChartType: 'Chart Type',
    spreadsheetChartTitle: 'Chart Title',
    spreadsheetXAxis: 'Label / X-axis',
    spreadsheetYAxis: 'Value / Y-axis',
    spreadsheetCreateChart: 'Create Chart',
    spreadsheetUseSuggestion: 'Use Suggestion',
    spreadsheetCustomChartTitle: 'Custom chart',
    spreadsheetChartNeedKeys: 'Please choose both label and value columns.',
    spreadsheetChartDefaultPrompt:
      'Suggest the best charts for this sheet with valid xKey and yKey from existing columns.',
    spreadsheetAiFailedTitle: 'Spreadsheet AI Failed',
    spreadsheetAiFailedDesc: 'The AI request failed. Please try again.',
    spreadsheetDefaultPrompt: 'Analyze this spreadsheet and provide actionable business insights.',
    spreadsheetReportDefaultPrompt:
      'Generate a sophisticated executive report with brief summary, analysis, key risks/opportunities, and chart suggestions.',
    spreadsheetPendingEdits: 'AI suggested {{count}} editable changes.',
    spreadsheetApplyEdits: 'Apply Suggested Edits',
    spreadsheetEditsApplied: 'Suggested edits were applied to the sheet.',
    spreadsheetGeneratedReport: 'Generated Report',
  ...
  ar: {
    ...
    daUploadPromptDesc: "قم بتحميل ملف CSV أو XLSX أو PDF أو يومية (.jrn) لإنشاء لوحة معلومات مع رؤى وتصورات.",
    ...
    daDragDropUnsupported: "يُرجى تحميل ملف CSV أو XLSX أو PDF أو .jrn.",
    daDragDropValid: "أفلت الملف لبدء التحليل",
    daDragDropInvalid: "نوع ملف غير مدعوم",
    daDragDropSupported: "المدعومة: CSV ، XLSX ، PDF ، JRN",
    ...
    spreadsheetImportSuccess: 'تم استيراد الجدول بنجاح.',
    spreadsheetImportFailedTitle: 'فشل الاستيراد',
    spreadsheetImportFailedDesc: 'تعذر قراءة الملف. جرّب CSV أو XLSX أو JSON أو TSV أو TXT أو JRN.',
    spreadsheetEmptyHint: 'ابدأ باستيراد جدول لإجراء التعديل والتحليل بمساعدة الذكاء الاصطناعي.',
    spreadsheetLoadedMessage: 'تم تحميل الجدول ({{rows}} صفوف، {{cols}} أعمدة) وهو جاهز لمساعدة الذكاء الاصطناعي.',
    ...
    spreadsheetPromptPlaceholder: 'اطلب من الذكاء الاصطناعي تنظيف الصفوف، شرح الشذوذ، توليد مؤشرات، أو إعداد تقرير...',
    spreadsheetAskAi: 'اسأل الذكاء',
    spreadsheetAnalyze: 'تحليل',
    spreadsheetReport: 'إنشاء تقرير',
    spreadsheetCharts: 'اقتراح رسوم',
    spreadsheetOpenChartBuilder: 'منشئ الرسوم',
    spreadsheetChartBuilderDesc: 'اختر نوع الرسم والحقول من اقتراحات الذكاء أو خصصها يدويًا.',
    spreadsheetChartType: 'نوع الرسم',
    spreadsheetChartTitle: 'عنوان الرسم',
    spreadsheetXAxis: 'التسميات / المحور X',
    spreadsheetYAxis: 'القيمة / المحور Y',
    spreadsheetCreateChart: 'إنشاء الرسم',
    spreadsheetUseSuggestion: 'استخدام الاقتراح',
    spreadsheetCustomChartTitle: 'رسم مخصص',
    spreadsheetChartNeedKeys: 'يرجى اختيار عمود التسميات وعمود القيم.',
    spreadsheetChartDefaultPrompt:
      'اقترح أفضل الرسوم لهذا الجدول مع xKey و yKey صالحين من الأعمدة الموجودة.',
    spreadsheetAiFailedTitle: 'فشل ذكاء الجداول',
    spreadsheetAiFailedDesc: 'فشل طلب الذكاء الاصطناعي. حاول مرة أخرى.',
    spreadsheetDefaultPrompt: 'حلّل هذا الجدول وقدّم رؤى عملية قابلة للتنفيذ.',
    spreadsheetReportDefaultPrompt:
      'أنشئ تقريرًا تنفيذيًا احترافيًا يتضمن ملخصًا مختصرًا وتحليلًا ومخاطر/فرص رئيسية واقتراحات رسوم.',
    spreadsheetPendingEdits: 'اقترح الذكاء الاصطناعي {{count}} تعديلات قابلة للتطبيق.',
    spreadsheetApplyEdits: 'تطبيق التعديلات المقترحة',
    spreadsheetEditsApplied: 'تم تطبيق التعديلات المقترحة على الجدول.',
    spreadsheetGeneratedReport: 'التقرير المُنشأ',
