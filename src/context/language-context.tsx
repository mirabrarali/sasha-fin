...
const translations: { [key in Language]: { [key: string]: string } } = {
  en: {
    ...
    learnChatDesc: "Engage with an AI that understands finance. Upload complex financial statements or loan data to receive an instant, institutional-quality report. Continue the conversation to dive deeper, ask follow-up questions, and even generate charts and graphs directly from your document data. Abdullah synthesizes information, critiques financial health, and visualizes data on command, becoming an indispensable partner for credit officers, analysts, and decision-makers.",
    learnSpreadsheetTitle: 'The Truly Agentic Spreadsheet',
    learnSpreadsheetDesc: "This is more than a grid of cells; it's an intelligent workspace where you command an expert AI financial analyst with natural language. Say 'Create a 5-year DCF model,' 'Analyze these sales figures and create a bar chart by region,' or 'Highlight all cells with negative profit in red.' Abdullah functions as a state-of-the-art AI agent—understanding your intent, structuring data, applying complex formulas, generating charts, and executing multi-step operations instantly.",
  ...
  ar: {
    ...
    learnChatDesc: "تفاعل مع ذكاء اصطناعي يفهم الأمور المالية. قم بتحميل بيانات مالية معقدة أو بيانات قروض للحصول على تقرير فوري بجودة مؤسسية. واصل المحادثة للتعمق أكثر وطرح أسئلة متابعة وحتى إنشاء مخططات ورسوم بيانية مباشرة من بيانات المستند. يقوم عبدالله بتجميع المعلومات ونقد الصحة المالية وتصور البيانات عند الطلب، ليصبح شريكًا لا غنى عنه لمسؤولي الائتمان والمحللين وصناع القرار.",
    learnSpreadsheetTitle: 'جدول البيانات الوكيلي الحقيقي',
    learnSpreadsheetDesc: "هذا أكثر من مجرد شبكة من الخلايا؛ إنها مساحة عمل ذكية حيث تأمر محللًا ماليًا خبيرًا بالذكاء الاصطناعي بلغة طبيعية. قل 'أنشئ نموذج DCF لمدة 5 سنوات'، 'حلل أرقام المبيعات هذه وأنشئ مخططًا شريطيًا حسب المنطقة'، أو 'ظلل جميع الخلايا ذات الربح السلبي باللون الأحمر'. يعمل عبدالله كوكيل ذكاء اصطناعي على أحدث طراز - يفهم نيتك، وينظم البيانات، ويطبق الصيغ المعقدة، وينشئ المخططات، وينفذ عمليات متعددة الخطوات على الفور.",
